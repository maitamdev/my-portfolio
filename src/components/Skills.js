  ...
  return (
    <>
      ...
      >
        ...
        <Skill name="Responsive UI" x="-20vw" y="-12vw" />
        <Skill name="ReactJS" x="0vw" y="12vw" />
        <Skill name="NodeJS" x="15vw" y="-12vw" />
        <Skill name="ExpressJS" x="32vw" y="-5vw" />
        <Skill name="AI Tools" x="0vw" y="-20vw" />
        <Skill name="API Integration" x="22vw" y="6vw" />
        <Skill name="REST APIs & CRUD" x="18vw" y="18vw" />
        <Skill name="Git & GitHub" x="-25vw" y="18vw" />
      </div>
    </>
  );
};
