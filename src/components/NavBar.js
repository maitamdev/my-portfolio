    ...
    >
      ...
      <div className='w-full flex justify-between items-center lg:hidden'>
        ...
        <nav className='flex items-center justify-center flex-wrap space-x-4'>
          <motion.a
            href="https://www.facebook.com/maitamdvfb"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6"
          ...
          <motion.a
            href="https://github.com/maitamdev"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6"
      ...
      {isOpen ? (
        ...
        >
          ...
          <nav className='flex items-center justify-center flex-wrap mt-6 space-x-4 sm:space-x-2'>
            <motion.a
              href="https://www.facebook.com/maitamdvfb"
              target={"_blank"}
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
              className="w-6 sm:w-5 text-light dark:text-dark"
            >
              <FacebookIcon />
            </motion.a>
            <motion.a
            ...
            <motion.a
              ...
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
              className="w-6 sm:w-5 bg-light rounded-full"
            >
              <PinterestIcon />
            </motion.a>
            <motion.a
