...
import { PhysicsWalker } from './Physics/PhysicsWalker.js'
...
export class Game
{
    ...
    async init()
    {
        ...
        const compressed = import.meta.env.PROD || import.meta.env.VITE_COMPRESSED === '1' || import.meta.env.VITE_COMPRESSED === 'true'
        ...
        const resourcesPromise = this.resourcesLoader.load(
            [
                ...
                [ 'character',                             `character/soldier.glb${cb}`,                                                         'gltf' ],
                ...
                [ 'timeMachineScreenMGSTexture',           `timeMachine/timeMachineScreenMGS.png${cb}`,                                          'texture', (resource) => { resource.minFilter = THREE.NearestFilter; resource.magFilter = THREE.NearestFilter; resource.generateMipmaps = false; resource.wrapS = THREE.ClampToEdgeWrapping; resource.wrapT = THREE.ClampToEdgeWrapping; resource.colorSpace = THREE.SRGBColorSpace; } ],
                [ 'timeMachineScreenFolioTexture',         `timeMachine/timeMachineScreenFolio.png${cb}`,                                        'texture', (resource) => { resource.minFilter = THREE.NearestFilter; resource.magFilter = THREE.NearestFilter; resource.generateMipmaps = false; resource.wrapS = THREE.ClampToEdgeWrapping; resource.wrapT = THREE.ClampToEdgeWrapping; resource.colorSpace = THREE.SRGBColorSpace; } ],
            ],
            (toLoad, total) =>
            {
        ...
        this.physicalWalker = new PhysicsWalker()
