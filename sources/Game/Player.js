...
export class Player
{
    ...
    setInputs()
    {
        this.game.inputs.addActions([
            ...
            { name: 'respawn',               categories: [ 'wandering', 'racing'              ], keys: [ 'Keyboard.KeyR', 'Gamepad.triangle' ] },
            { name: 'nitro',                 categories: [ 'wandering', 'racing'              ], keys: [ 'Keyboard.ShiftLeft', 'Gamepad.button3' ] },
            { name: 'suspensions',           categories: [ 'wandering', 'racing'              ], keys: [ 'Keyboard.Space', 'Gamepad.square' ] },
